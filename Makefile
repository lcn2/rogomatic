...
have_stdbool.h: ${MAKE_FILE}
	...
	${Q} echo '' >> $@
	${Q} echo '' >> $@
	${Q} echo '#if !defined(ROGO_HAVE_STDBOOL_H)' >> $@
	${Q} echo '#define ROGO_HAVE_STDBOOL_H' >> $@
	${Q} echo '' >> $@
	${Q} echo '' >> $@
...
arms.o: arms.c
arms.o: globals.h
arms.o: have_stdbool.h
arms.o: types.h
command.o: command.c
command.o: globals.h
command.o: have_stdbool.h
command.o: types.h
config.o: config.c
config.o: globals.h
...
database.o: have_stdbool.h
database.o: types.h
debug.o: debug.c
debug.o: globals.h
debug.o: have_stdbool.h
debug.o: install.h
debug.o: types.h
debuglog.o: debuglog.c
debuglog.o: have_stdbool.h
debuglog.o: types.h
explore.o: explore.c
explore.o: globals.h
...
getroguetoken.o: have_stdbool.h
getroguetoken.o: termtokens.h
getroguetoken.o: types.h
histplot.o: have_stdbool.h
...
monsters.o: types.h
pack.o: globals.h
pack.o: have_stdbool.h
pack.o: pack.c
pack.o: types.h
rand.o: rand.c
replay.o: globals.h
replay.o: have_stdbool.h
replay.o: replay.c
replay.o: types.h
rgmplot.o: have_stdbool.h
rgmplot.o: rgmplot.c
rgmplot.o: types.h
rooms.o: globals.h
...
scorefile.o: have_stdbool.h
scorefile.o: install.h
scorefile.o: scorefile.c
scorefile.o: types.h
search.o: globals.h
search.o: have_stdbool.h
search.o: search.c
search.o: types.h
setup.o: have_stdbool.h
setup.o: install.h
setup.o: setup.c
setup.o: types.h
