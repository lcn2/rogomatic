...
/* Stuff list, list of objects on this level, +1 for paranoia */
stuffrec slist[MAXSTUFF + 1];	int slistlen=0;

/* Monster list, list of monsters on this level, +1 for paranoia */
monrec mlist[MAXMONST + 1];	int mlistlen=0;
